...
La predizione delle proprietà molecolari è difficile per la scarsità di dati etichettati e la complessità delle rappresentazioni; per questo si usano modelli pre-addestrati seguiti da fine-tuning. L'aumento di complessità dei modelli comporta però maggiori emissioni di CO2. Sebbene esistano studi su criteri di sostenibilità (es. early stopping basato su CO2) nei sistemi di raccomandazione, la loro applicazione al training molecolare rimane ancora poco esplorata.
